...
class VectorScaleBoxPluginLayer(QgsPluginLayer):
  ...
  LAYER_TYPE="vectorscalebox"

  def __init__(self):
    QgsPluginLayer.__init__(self, VectorScaleBoxPluginLayer.LAYER_TYPE, "Vector scale box plugin layer")
    self.setValid(True)
  ...
  def writeXml(self, node, doc):
    ...
    element.setAttribute("name", VectorScaleBoxPluginLayer.LAYER_TYPE);
    # custom properties
...
class VectorScaleBoxPluginLayerType(QgsPluginLayerType):

  def __init__(self):
    QgsPluginLayerType.__init__(self, VectorScaleBoxPluginLayer.LAYER_TYPE)
